...
# Next Steps for ndx-fiber-photometry Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-fiber-photometry directory: `cd ndx-fiber-photometry`
...
`spec/ndx-fiber-photometry.namespace.yaml` and
`spec/ndx-fiber-photometry.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-fiber-photometry
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/alessandratrapani/ndx-fiber-photometry/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-fiber-photometry/0.1.0
...
`staged-extensions/ndx-fiber-photometry`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-fiber-photometry
    ```

13. Edit `staged-extensions/ndx-fiber-photometry/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/alessandratrapani/ndx-fiber-photometry
      pip: https://pypi.org/project/ndx-fiber-photometry/
      license: BSD-3
      maintainers: 
        - alessandratrapani
      ```

14. Edit `staged-extensions/ndx-fiber-photometry/README.md`
to add information about your extension. You may copy it from
`ndx-fiber-photometry/README.md`.

  ```bash
  cp ndx-fiber-photometry/README.md staged-extensions/ndx-fiber-photometry/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-fiber-photometry
git commit -m "Add new catalog entry for ndx-fiber-photometry" .
git push
```
...
ndx-fiber-photometry-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-fiber-photometry GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-fiber-photometry-record repository on GitHub.
