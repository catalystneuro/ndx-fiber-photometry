...
project = 'ndx-fiber-photometry'
copyright = '2024, Alessandra Trapani, Luiz Tauffer, Paul Adkisson, Szonja Weigl'
author = 'Alessandra Trapani, Luiz Tauffer, Paul Adkisson, Szonja Weigl'
